-- Fix get_monthly_finance_stats to correctly count 0% VAT and include it in totals
...
BEGIN
    ...
    stats AS (
        SELECT 
            ...
            SUM(CASE WHEN vat_code = '0%' THEN total_price ELSE 0 END) as v0 -- Correctly sum 0% items
